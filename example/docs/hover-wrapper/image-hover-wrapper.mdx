import {ImageHoverWrapper} from '@site/src/components/image-hover';
...
<ImageHoverWrapper imageName="sky.jpg" content="Beautiful Sky" tag="span" />
...
<ImageHoverWrapper imageName="click.png" content="Click for more!" tag="button" />
...
<ImageHoverWrapper imageName="landscape.jpg" content="Discover Amazing Landscapes" tag="h2" />
